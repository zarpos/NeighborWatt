...
const Landpage2 = () => {
  return (
    <div className={styles.landpage2}>
      ...
      <img className={styles.diamond1Icon} alt="Transparency logo" src="/diamond-1@2x.png" />
      <img className={styles.plant1Icon} alt="Plant logo" src="/plant-1@2x.png" />
      ...
      <img className={styles.connect1Icon} alt="Connect logo" src="/Connect.png" />
    </div>
  );
};
